...
namespace COINROOTUI
{
    public partial class mediaplayer : Form
    {
        ...
        {
            using (OpenFileDialog ofd = new OpenFileDialog() { Multiselect = true, ValidateNames = true, Filter = "WMV|*.wmv|WAV|*.wav|MP3|*.mp3|MP4|*.mp4|MKV|*.mkv|HD|*.hd|MPEG|*.mpeg|ALL FILES|*.all files" })
            {
